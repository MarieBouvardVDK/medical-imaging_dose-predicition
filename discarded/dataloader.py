...
from discarded.batch import DataBatch
from discarded.shapes import DataShapes
from discarded.utils import get_paths, load_file
...
class DataLoader:
    ...
    def prepare_data(self, file_paths_to_load: List[Path]):
